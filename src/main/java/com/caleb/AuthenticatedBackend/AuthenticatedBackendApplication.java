package com.caleb.AuthenticatedBackend;
...
public class AuthenticatedBackendApplication {
	...
	@Bean
	CommandLineRunner run(RoleRepository roleRepository, UserRepository userRepository, PasswordEncoder encoder, PasswordEncoder passwordEncoder) {
		return args ->{
